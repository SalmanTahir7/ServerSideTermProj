<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="PaymentProcessor.Registration" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <section>
            ...
            <article>
                <div ID="Restaurant" runat="server">
                    ...
                    <br />
                    <asp:Button ID="btnRSubmit" runat="server" Text="Submit" OnClick="btnRSubmit_Click" />
                </div>
                <div ID="Customer" runat="server">
                    ...
                    <br />
                   <asp:Button ID="btnCSubmit" runat="server" Text="Submit" OnClick="btnCSubmit_Click" />
                </div>
            </article>
        </section>
        ...
        <footer>
            ...
            <asp:Label ID="lblProcess" runat="server" Text="Posted!" Visible="false"></asp:Label>
        </footer>
